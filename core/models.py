...
class Ingredient(models.Model):
    ...
    unitary_cost = models.DecimalField(
        ...
        null=True,
        blank=True,
        validators=[MinValueValidator(0.0, "Costul unitar nu poate fi negativ")],
    )
    ingredient_type = models.CharField(
        choices=IngredientType, max_length=20, default=IngredientType.INGREDIENT
    )
...
class RecipeIngredient(models.Model):
    ...
    loss_factor = models.DecimalField(
        ...
        decimal_places=2,
        validators=[
            MinValueValidator(0.0, message="Factorul nu poate fi negativ"),
            MaxValueValidator(1.0, message="Factorul nu poate fi mai mare decat 1"),
        ],
        default=0,
    )
