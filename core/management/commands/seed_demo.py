...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "receipt_lines", type=int, help="How many receipt lines to be added", default=3
        )
        parser.add_argument(
            "ingredients", type=int, help="How many ingredients to be added", default=3
        )
    ...
    def handle(self, *args, **opts):
        ...
        menu_items = [
            MenuItem.objects.get_or_create(name=f"Element de meniu {i}")[0]
        ...
        for receipt in receips:
            for menu_item in menu_items:
                ...
                rl += 1
        ReceiptLine.objects.bulk_create(receipt_lines, ignore_conflicts=True)
